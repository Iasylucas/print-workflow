// frontend/src/features/quotes/components/QuoteFilters.tsx
...
import { QUOTE_STATUSES } from "../schema/quotes.schema";
import type { QuotesQueryParams } from "../types/quotes.types";
import type { QuoteStatus } from "../schema/quotes.schema";

interface QuoteFiltersProps {
  filters: QuotesQueryParams;
  onFilterChange: (newFilters: Partial<QuotesQueryParams>) => void;
}
    ...
    <div className="flex flex-col sm:flex-row items-end sm:items-center justify-between gap-3 w-full pb-0">
      ...
      <div className="flex items-center gap-2 w-full sm:w-auto justify-start sm:justify-end flex-wrap">
        ...
        <Select
          ...
          onValueChange={(val) =>
            onFilterChange({
              status: val === "ALL" ? undefined : (val as QuoteStatus),
              page: 1,
            })
          }
        >
